  ...
  async CalculateEuroPerDay(){
   ...
   showNotif(){
    PushNotification.localNotification({
      ...
      bigText: "2My big text that will be shown when notification is expanded. Styling can be done using HTML tags(see android docs for details)", // (optional) default: "message" prop
      ...
      title: "My Notification Title2", // (optional)
